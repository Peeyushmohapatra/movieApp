  ...
  return (
    <div className="movieDetailsContainer">
      ...
      <div className="movieImageContainer">
        ...
        />
        <div className="lastImageContsiner">

        </div>
        <div className="movieFullDetails">
          <h2 className="movieTitle">{movies && movies.title}</h2>
          <p>Status: <span>{movies && movies.status}</span></p>
          <p>Release Date: <span>{movies && movies.release_date}</span> </p>
          <p>RumTime: <span> {movies && movies.runtime} min</span> </p>
          ...
          <p>Rating: <span>{movies && movies.vote_average.toFixed(1)}</span> </p>
          <p>Description: <span>{movies && movies.overview}</span></p>
        </div>
      </div>
    </div>
  );
